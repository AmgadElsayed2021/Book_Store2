...
<form action="library-data" method="post">
    ...
    <label>Book ISBN   : </label><label><input type="text" name="isbn"></label>
    <label>Book Title  : </label><label><input type="text" name="title"></label>
    <label>Edition no  : </label><label><input type="text" name="edition"></label>
    <label>Copy Right  : </label><label><input type="text" name="copyright"></label>
